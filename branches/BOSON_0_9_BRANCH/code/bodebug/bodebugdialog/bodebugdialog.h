 ...
 * @version $Id$
 */
class BoDebugDialog : public BoAbstractDebugDialog
{
  Q_OBJECT

public:
  BoDebugDialog( QStringList areaList, QWidget *parent=0, const char *name=0, bool modal=true );
  virtual ~BoDebugDialog();
...
private:
  ...
  BoDebugDialog( const BoDebugDialog& );
  BoDebugDialog& operator= ( const BoDebugDialog& );
};
