...
// AB: XXX notice the license! this is neither GPL nor LGPL !
// we must NOT use this code in boson!
//
// but we can of course use the output of this code without restrictions (as
// long as the fonts have been free initially)
