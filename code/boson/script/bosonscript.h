...
class BosonScript
{
  public:
     ...
     **/
    unsigned long int minerals(int playerId);
    /**
     ...
     **/
    unsigned long int oil(int playerId);
    /**
     ...
     **/
    QValueList<BoVector2Fixed> nearestMineralLocations(int playerId, int x, int y, unsigned int n, unsigned int radius);
    /**
     ...
     **/
    QValueList<BoVector2Fixed> nearestOilLocations(int playerId, int x, int y, unsigned int n, unsigned int radius);
     ...
     * way
     **/
    void moveUnit(int player, int id, float x, float y);
    /**
     * Moves unit with id id to (x, y)
     * Unit will shoot at any enemy units on the way
     **/
    void moveUnitWithAttacking(int player, int id, float x, float y);
    /**
     * Unit with id attackerId will attack unit targetId
     **/
    void attack(int player, int attackerId, int targetId);
    /**
     * Stops unit with id id from doing anything
     **/
    void stopUnit(int player, int id);
    /**
     * Sends unit with id id to mine at (x, y)
     **/
    void mineUnit(int player, int id, float x, float y);
    /**
     * Sets unit's rotation to rotation
     **/
    void setUnitRotation(int player, int id, float rotation);
    /**
     * Drops bomb with given unit with specified weapon to given pos
     **/
    void dropBomb(int player, int id, int weapon, float x, float y);
    /**
     * Produces unit with type production in factory with id factory
     **/
    void produceUnit(int player, int factory, int production);
    /**
     * Spawns unit owned by player, with type type, at (x, y)
     **/
    void spawnUnit(int player, int type, float x, float y);
    /**
     * Teleports (immediately moves) unit with id id, owned by player to (x, y)
     **/
    void teleportUnit(int player, int id, float x, float y);
    /**
     ...
     **/
    void placeProduction(int player, int factoryid, float x, float y);
    bool canPlaceProductionAt(int player, int factoryid, int unitType, float x, float y);
     ...
     **/
    BoVector2Fixed unitPosition(int id);
    /**
     ...
     **/
    bool isUnitTypeMobile(int playerid, int type);
    /**
     * @return Whether unit with id id is an aircraft
     **/
    bool isUnitAircraft(int id);
    /**
     * @return Whether unit with given type is aircraft
     **/
    bool isUnitTypeAircraft(int playerid, int type);
    /**
     ...
     *  many units
     **/
    int allPlayerUnitsCount(int id);
    /**
     * @return List containing all units with given type, belonging to player
     *  with given id
     **/
    QValueList<int> playerUnitsOfType(int playerid, int type);
    /**
     * @return how many units of given type player with given id has
     **/
    int playerUnitsOfTypeCount(int playerid, int type);
  ...
  protected:
    ...
    void sendInput(int player, QDataStream& stream);
