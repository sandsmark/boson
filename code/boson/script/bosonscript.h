...
class BosonScript
{
  public:
    ...
    static bool canPlaceProductionAt(int player, int factoryid, int unitType, float x, float y);
     ...
     **/
    static bool hasUnitCompletedProduction(int id);
    /**
     * @return The typeID of the completed production of unit @p id, or 0 if @p
     * id has no completed productions
     **/
    static unsigned long int completedProductionType(int id);
    /**
