...
class BosonScript
{
  public:
    ...
    unsigned long int powerConsumedAfterConstructions() const;
    /**
    ...
    unsigned long int powerGeneratedAfterConstructions() const;
