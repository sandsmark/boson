...
class BosonScript
{
  public:
     ...
     **/
    quint32 minerals(int playerId) const;
     ...
     **/
    quint32 oil(int playerId) const;
     ...
     **/
    quint32 completedProductionType(int id) const;
    /**
