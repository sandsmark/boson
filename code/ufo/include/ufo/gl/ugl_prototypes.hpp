...
UFO_GL_PROC_UNUSED(void,glDrawArrays,(GLenum mode, GLint first, GLsizei count))
...
UFO_GL_PROC_UNUSED(void,glInterleavedArrays,(GLenum format, GLsizei stride, const GLvoid *pointer))
