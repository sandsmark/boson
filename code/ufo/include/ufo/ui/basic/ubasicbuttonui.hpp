/***************************************************************************
    ...
    file              : include/ufo/ui/basic/ubasicbuttonui.hpp
...
#ifndef UBASICBUTTONUI_HPP
#define UBASICBUTTONUI_HPP

#include "../ubuttonui.hpp"
...
class UFO_EXPORT UBasicButtonUI : public UButtonUI {
	UFO_DECLARE_DYNAMIC_CLASS(UBasicButtonUI)
public:
	UBasicButtonUI();

	static UBasicButtonUI * createUI(UWidget * w);
...
protected:  // protected methods
	virtual void installSignals(UButton * b);
	virtual void uninstallSignals(UButton * b);
...
private:  // Private attributes
	...
	static UBasicButtonUI * m_buttonUI;
