...
draw_bigbox_text("Boson is an OpenGL real-time strategy game, with the feeling of
...
draw_bigbox_text("<b>Notice:</b> Note that these requirements apply to current
    development (CVS) version.<br>
    Latest stable release ($latestversion) probably runs on slower system and it
    it doesn't require 3D accelerator card. Also, it doesn't need lib3ds or OpenGL.<br><br>
    <b>Minimum hardware requirements:</b><br>
    Note: If you have a older graphics card like a TNT2 you will need a fast CPU.<br>
...
draw_bigbox_text("To compile Boson (you don't need compiler if you're downloading binary version),
