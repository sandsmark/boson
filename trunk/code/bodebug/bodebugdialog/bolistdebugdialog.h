 ...
 * @version $Id$
 */
class BoListDebugDialog : public BoAbstractDebugDialog
{
  Q_OBJECT

public:
  BoListDebugDialog( QStringList areaList, QWidget *parent=0, const char *name=0, bool modal=true );
  virtual ~BoListDebugDialog() {}
