...
*/
#ifndef BOMESHRENDERERSEMIIMMEDIATE_H
#define BOMESHRENDERERSEMIIMMEDIATE_H

#include "../bomeshrenderer.h"

class BoMeshRendererSemiImmediate : public BoMeshRenderer
{
	Q_OBJECT
public:
	BoMeshRendererSemiImmediate();
	~BoMeshRendererSemiImmediate();
